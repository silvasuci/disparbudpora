                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            if (isset($cari)) {
                                $jumlah_record = mysqli_query($db, "SELECT * FROM users WHERE potensi_wisata LIKE '%$cari%' OR nama LIKE '%$cari%'") or die('Ada kesalahan pada query jumlah_record: ' . mysqli_error($db));
                            } else {
                            ...
                            $no = 1;
                            if (isset($cari)) {
                                $query = mysqli_query($db, "SELECT * FROM users WHERE potensi_wisata LIKE '%$cari%' OR nama LIKE '%$cari%' ORDER BY nis LIMIT $mulai, $batas")
                      ...
                      <td width='150'>$data[potensi_wisata]</td>
