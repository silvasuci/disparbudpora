...
<body>
    ...
    <div class="kotak_login">
        ...
        <form action="proses-daftar.php" method="post">
            ...
            <P><input type="text" name="username" class="form_login" placeholder="Masukan Nama Pokdarwis" required="required"></P>
            <p><label>Alamat</label>
            <P><input type="text" name="alamat" class="form_login" placeholder="Masukan Alamat Pokdarwis" required="required"></P>
            <p><label>Potensi</label>
            <P><input type="text" name="potensi" class="form_login" placeholder="Masukan Potensi wisata" required="required"></P>
