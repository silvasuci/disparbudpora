...
if ($foto != "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        $query  = "UPDATE users SET nip = '$nip', nama = '$nama', tanggal_lahir = '$tanggal_lahir', alamat = '$alamat', instansi = '$instansi', stat = '$stat', telp = '$telp',  foto = '$nama_foto_baru'";
        $query .= "WHERE nip = '$nip'";
    ...
    // jalankan query UPDATE berdasarkan nip yang usersnya kita edit
    $query  = "UPDATE users SET nip = '$nip', nama = '$nama', tanggal_lahir = '$tanggal_lahir', alamat = '$alamat', instansi = '$instansi', stat = '$stat', telp = '$telp'";
    $query .= "WHERE nip = '$nip'";
    $result = mysqli_query($db, $query);
    // periska query apakah ada error
    if (!$result) {
